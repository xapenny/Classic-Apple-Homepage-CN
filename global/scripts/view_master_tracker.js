...
}catch(f){}if(this.isReplay){d="V@R: "}else{d="V@S: "}g.pageName=d+this._pageName;
if(typeof this.type==="undefined"){g.prop13=g.pageName;g.prop4=(this.isSnowLeopardControllerAvailable())?c.src():c.GetURL();
AC.Tracking.trackPage(g);g.prop13=g.prop3=g.prop4=""}else{s.prop13=d+this._pageName;
s.prop4=(this.isSnowLeopardControllerAvailable())?c.src():c.GetURL();s.eVar16=s.prop16="Video Plays";
s.events="event2";s.Media.trackVars+=",events,prop13,prop4,prop16,eVar16";s.Media.trackEvents+=",event2"
}if(this.delegate&&typeof this.delegate.QTdidBegin=="function"){g=this.delegate.QTdidBegin(this,g);
